    ...
    var SketchPad = function(paper, options) {
        ...
        function _pathclick(e) {
            if (_options.editing == "erase") {
                ...
                /**
                 * [svg_path_to_string description]
                 * @param  {[path]} path [takes stroke.path]
                 * @return {[String]}      [returns the path converted into String]
                 */
                function svg_path_to_string(path) {
                    var str = "";
                    for (var i = 0, n = path.length; i < n; i++) {
                ...
                for (var i = 0, n = _strokes.length; i < n; i++) {
                    var s = _strokes[i];
                    // update obselete comparison condition
